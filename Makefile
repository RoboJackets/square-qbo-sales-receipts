...
env.json:
    echo '{"ApiLambda": {"SQUARE_TOKEN": "", "SQUARE_SIGNATURE_KEY": "", "QUICKBOOKS_CLIENT_ID": "", "QUICKBOOKS_CLIENT_SECRET": "", "QUICKBOOKS_COMPANY_ID": "", QUICKBOOKS_ACCESS_TOKEN": "", "QUICKBOOKS_REFRESH_TOKEN": ""}}' > env.json
